...
<div class="box">
            <div class="box-header">
              <h3 class="box-title">Isi Daftar Pengarang</h3>
            </div>
            <div class="box-body">
             ...
             <?php
                foreach ($data as $row){?>
                    ...
                    <td> 
                        ...
                        <a href="<?= base_url()?>pengarang/hapus/<?= $row->id_pengarang;?>" class= "btn btn-danger btn-xs" onclick="return confirm('Apakah ingin menghapus data ini?')";> Hapus</a>
                    </td>
                </tr>
                <?php }
             ?>
