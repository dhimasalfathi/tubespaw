...
$table1 = '<table border="0" width= "650px" >';
    $table1.='<tr> 
            <td style="text-align: center; font-family:sans-serif; font-size: 16px; font-weight:bold;">Laporan Peminjaman</td>
            </tr>';
...
$table2 = '<table border="1" width= "650px" >';
    $table2 .='<tr style="background-color:lightblue;"> 
            <td height="30" style="text-align: center; font-weight: bold;">ID Peminjaman</td>
            <td style="text-align: center; font-weight: bold; font-family: sans-serif; font-sized:12px;">Peminjam</td>
            <td style="text-align: center; font-weight: bold; font-family: sans-serif; font-sized:12px;">Buku</td>
            <td style="text-align: center; font-weight: bold; font-family: sans-serif; font-sized:12px;">Tanggal Pinjam</td>
            <td style="text-align: center; font-weight: bold; font-family: sans-serif; font-sized:12px;">Tanggal Kembali</td>
            </tr>';
